...
Open your browser on [http://localhost:8080](http://localhost:8080). You should see "Hello". You can press ctrl+c in your terminal to stop the server.
...
This makes it ignore _any_ directory called `node_modules`, wherever it is \(it previously only worked on directories exactly one node deep\).
