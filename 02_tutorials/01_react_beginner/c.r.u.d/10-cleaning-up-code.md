...
Compare with the previous method. None of the **functionality** of `createContact` has changed, however, it is much easier to _read_. Each line expressed its intent in a much clearer manner than before.
